...
export default function getAddressAvatar(address) {
    ...
    return `<svg viewBox="0 0 ${SIZE} ${SIZE}" fill="none" role="img" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
...
//# sourceMappingURL=getAddressAvatar.js.map